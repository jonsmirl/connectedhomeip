...
#define MATTER_DM_LOWPAN_LOCATION_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_LOWPAN_BLE_SENSOR_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_LOWPAN_WEB_SERVER_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_LOWPAN_HARDWARE_MODE_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_LOWPAN_PROXY_MODE_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_LOWPAN_HARDWARE_MODE_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
#define MATTER_DM_LOWPAN_PROXY_MODE_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
