 ...
 */
class ThermostatAppBasicInformationAttrAccess : public AttributeAccessInterface
{
public:
    ThermostatAppBasicInformationAttrAccess() : AttributeAccessInterface(Optional<EndpointId>::Missing(), BasicInformation::Id) {}
