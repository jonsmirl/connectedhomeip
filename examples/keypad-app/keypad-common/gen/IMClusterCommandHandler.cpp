                                                          ...
                                                          TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        switch (aCommandPath.mCommandId)
        {
        case Commands::AddSensorEp::Id: {
            Commands::AddSensorEp::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfLowpanBleSensorClusterAddSensorEpCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveSensorEp::Id: {
            Commands::RemoveSensorEp::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfLowpanBleSensorClusterRemoveSensorEpCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
                                                          ...
                                                          TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled     = false;
    {
        switch (aCommandPath.mCommandId)
        {
        case Commands::AddGroupEp::Id: {
            Commands::AddGroupEp::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfLowpanGroupClusterAddGroupEpCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::RemoveGroupEp::Id: {
            Commands::RemoveGroupEp::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfLowpanGroupClusterRemoveGroupEpCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::Configuration::Id: {
            Commands::Configuration::DecodableType commandData;
            TLVError = DataModel::Decode(aDataTlv, commandData);
            if (TLVError == CHIP_NO_ERROR)
            {
                wasHandled = emberAfLowpanGroupClusterConfigurationCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
...
void DispatchSingleClusterCommand(const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aReader, CommandHandler * apCommandObj)
{
    ...
    case Clusters::LowpanBleSensor::Id:
        errorStatus = Clusters::LowpanBleSensor::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;
    case Clusters::LowpanGroup::Id:
        errorStatus = Clusters::LowpanGroup::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;
