 ...
 */
class MicrowaveOvenAppBasicInformationAttrAccess : public AttributeAccessInterface
{
public:
    MicrowaveOvenAppBasicInformationAttrAccess() : AttributeAccessInterface(Optional<EndpointId>::Missing(), BasicInformation::Id) {}
