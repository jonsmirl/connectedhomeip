...
#include "MicrowaveOvenAppBasicInformation.h"
...
constexpr char kNodeLabelKey[]       = "microwave-oven-app-node-label";
constexpr size_t kMaxNodeLabelLength = 32; // Matter specification limit

CHIP_ERROR MicrowaveOvenAppBasicInformationAttrAccess::Read(const ConcreteReadAttributePath & aPath,
                                                            AttributeValueEncoder & aEncoder)
{
    ...
    case Attributes::ProductName::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Microwave Oven"));
    case Attributes::ProductLabel::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Microwave Oven"));
    case Attributes::PartNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("MW-001"));
    case Attributes::SerialNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("MW-123456"));
    case Attributes::UniqueID::Id:
        return aEncoder.Encode(CharSpan::fromCharString("MW-UID-123456"));
    default:
...
CHIP_ERROR MicrowaveOvenAppBasicInformationAttrAccess::Write(const ConcreteDataAttributePath & aPath,
...
CHIP_ERROR MicrowaveOvenAppBasicInformationAttrAccess::ReadNodeLabel(AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR MicrowaveOvenAppBasicInformationAttrAccess::WriteNodeLabel(AttributeValueDecoder & aDecoder)
{
    CharSpan nodeLabel;
