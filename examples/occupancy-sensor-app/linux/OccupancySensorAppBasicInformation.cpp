...
constexpr char kNodeLabelKey[]       = "occupancy-sensor-app-node-label";
constexpr size_t kMaxNodeLabelLength = 32; // Matter specification limit

CHIP_ERROR OccupancySensorAppBasicInformationAttrAccess::Read(const ConcreteReadAttributePath & aPath,
                                                              AttributeValueEncoder & aEncoder)
{
    ...
    case Attributes::ProductName::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Occupancy Sensor"));
    case Attributes::ProductLabel::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Occupancy Sensor"));
    case Attributes::PartNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("OCC-001"));
    case Attributes::SerialNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("OCC-123456"));
    case Attributes::UniqueID::Id:
        return aEncoder.Encode(CharSpan::fromCharString("OCC-UID-123456"));
    default:
...
CHIP_ERROR OccupancySensorAppBasicInformationAttrAccess::Write(const ConcreteDataAttributePath & aPath,
...
CHIP_ERROR OccupancySensorAppBasicInformationAttrAccess::ReadNodeLabel(AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR OccupancySensorAppBasicInformationAttrAccess::WriteNodeLabel(AttributeValueDecoder & aDecoder)
{
    CharSpan nodeLabel;
