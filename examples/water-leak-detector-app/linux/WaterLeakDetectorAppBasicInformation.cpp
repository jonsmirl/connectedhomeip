...
constexpr char kNodeLabelKey[]       = "water-leak-detector-app-node-label";
constexpr size_t kMaxNodeLabelLength = 32; // Matter specification limit

CHIP_ERROR WaterLeakDetectorAppBasicInformationAttrAccess::Read(const ConcreteReadAttributePath & aPath,
                                                                AttributeValueEncoder & aEncoder)
{
    ...
    case Attributes::ProductName::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Water Leak Detector"));
    case Attributes::ProductLabel::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Water Leak Detector"));
    case Attributes::PartNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("WLD-001"));
    case Attributes::SerialNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("WLD-123456"));
    case Attributes::UniqueID::Id:
        return aEncoder.Encode(CharSpan::fromCharString("WLD-UID-123456"));
    default:
...
CHIP_ERROR WaterLeakDetectorAppBasicInformationAttrAccess::Write(const ConcreteDataAttributePath & aPath,
...
CHIP_ERROR WaterLeakDetectorAppBasicInformationAttrAccess::ReadNodeLabel(AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR WaterLeakDetectorAppBasicInformationAttrAccess::WriteNodeLabel(AttributeValueDecoder & aDecoder)
{
    CharSpan nodeLabel;
