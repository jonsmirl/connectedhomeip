...
#include "ContactSensorAppBasicInformation.h"
...
constexpr char kNodeLabelKey[]       = "contact-sensor-app-node-label";
constexpr size_t kMaxNodeLabelLength = 32; // Matter specification limit

CHIP_ERROR ContactSensorAppBasicInformationAttrAccess::Read(const ConcreteReadAttributePath & aPath,
                                                            AttributeValueEncoder & aEncoder)
{
    ...
    case Attributes::ProductName::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Contact Sensor"));
    case Attributes::ProductLabel::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Contact Sensor"));
    case Attributes::PartNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("CS-001"));
    case Attributes::SerialNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("CS-123456"));
    case Attributes::UniqueID::Id:
        return aEncoder.Encode(CharSpan::fromCharString("CS-UID-123456"));
    default:
...
CHIP_ERROR ContactSensorAppBasicInformationAttrAccess::Write(const ConcreteDataAttributePath & aPath,
...
CHIP_ERROR ContactSensorAppBasicInformationAttrAccess::ReadNodeLabel(AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR ContactSensorAppBasicInformationAttrAccess::WriteNodeLabel(AttributeValueDecoder & aDecoder)
{
    CharSpan nodeLabel;
