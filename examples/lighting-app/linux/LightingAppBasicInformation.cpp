...
constexpr char kNodeLabelKey[]       = "lighting-app-node-label";
constexpr size_t kMaxNodeLabelLength = 32; // Matter specification limit

CHIP_ERROR LightingAppBasicInformationAttrAccess::Read(const ConcreteReadAttributePath & aPath, AttributeValueEncoder & aEncoder)
{
    ...
    case Attributes::ProductName::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Extended Color Light"));
    case Attributes::ProductLabel::Id:
        return aEncoder.Encode(CharSpan::fromCharString("Extended Color Light"));
    case Attributes::PartNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("LIGHT-001"));
    case Attributes::SerialNumber::Id:
        return aEncoder.Encode(CharSpan::fromCharString("LIGHT-123456"));
    case Attributes::UniqueID::Id:
        return aEncoder.Encode(CharSpan::fromCharString("LIGHT-UID-123456"));
    default:
...
CHIP_ERROR LightingAppBasicInformationAttrAccess::Write(const ConcreteDataAttributePath & aPath, AttributeValueDecoder & aDecoder)
{
...
CHIP_ERROR LightingAppBasicInformationAttrAccess::ReadNodeLabel(AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR LightingAppBasicInformationAttrAccess::WriteNodeLabel(AttributeValueDecoder & aDecoder)
{
    CharSpan nodeLabel;
