...
#include "include/HumidityMeasurementAppBasicInformation.h"
...
CHIP_ERROR HumidityMeasurementAppBasicInformationAttrAccess::Read(const ConcreteReadAttributePath & aPath,
...
CHIP_ERROR HumidityMeasurementAppBasicInformationAttrAccess::Write(const ConcreteDataAttributePath & aPath,
...
CHIP_ERROR HumidityMeasurementAppBasicInformationAttrAccess::ReadNodeLabel(AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR HumidityMeasurementAppBasicInformationAttrAccess::WriteNodeLabel(AttributeValueDecoder & aDecoder)
{
