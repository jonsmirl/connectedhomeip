...
// Rocker device combines both light and switch functionality
...
// Rocker device type - using a custom device type for dual endpoint device
...
#define CHIP_DEVICE_CONFIG_DEVICE_PRODUCT_ID 0x8007 // Rocker product ID
#define CHIP_DEVICE_CONFIG_DEVICE_NAME "Rocker Device"
 ...
 */
#define CHIP_DEVICE_CONFIG_TEST_SERIAL_NUMBER "ROCKER_SN"
 ...
 * is found in Chip NV storage.
 */
#define CHIP_DEVICE_CONFIG_TEST_PRODUCT_LABEL "Rocker Device"
