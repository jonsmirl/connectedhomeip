...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(25), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */                                         \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 10, 110 },                                                                                         \
        { ZAP_CLUSTER_INDEX(10), 7, 79 },                                                                                          \
        { ZAP_CLUSTER_INDEX(17), 16, 242 },                                                                                        \
    }
...
#define FIXED_DEVICE_TYPES { { 0x00000016, 1 }, { 0xFFF30005, 1 }, { 0x0000010D, 4 }, { 0xFFF30004, 1 } }
...
#define FIXED_PARENT_ENDPOINTS { kInvalidEndpointId, kInvalidEndpointId, 1 }
