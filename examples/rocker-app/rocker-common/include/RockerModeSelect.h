...
namespace RockerModeSelect {

// Mode definitions for the rocker switch
...
class RockerModeSelectDelegate : public ModeBase::Delegate
{
private:
...
public:
    ~RockerModeSelectDelegate() override = default;
};
