...
/**
 * @brief Rocker Manager
 *
 * This class manages the dual-endpoint rocker device functionality:
...
{
public:
    static RockerManager & GetInstance()
    {
        static RockerManager sInstance;
        return sInstance;
    }

    /**
     * @brief Initialize the rocker manager
     *
    ...
    /**
     * @brief Shutdown the rocker manager
     */
    void Shutdown();
