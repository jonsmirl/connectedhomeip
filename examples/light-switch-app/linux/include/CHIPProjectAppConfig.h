 ...
 *          to the default CHIP configuration that are common to the whole
 *          application, regardless of which platform it is running on.
 *
 */

#pragma once

// Enable client clusters for light switch functionality
 ...
 * is found in Chip NV storage.
 */
#define CHIP_DEVICE_CONFIG_TEST_PRODUCT_LABEL "Light Switch"
