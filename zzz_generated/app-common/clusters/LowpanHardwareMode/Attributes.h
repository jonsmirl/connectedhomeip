...
#include <clusters/LowpanHardwareMode/Structs.h>
...
struct TypeInfo
{
    using Type = chip::app::DataModel::List<const chip::app::Clusters::LowpanHardwareMode::Structs::ModeOptionStruct::Type>;
    using DecodableType =
        chip::app::DataModel::DecodableList<chip::app::Clusters::LowpanHardwareMode::Structs::ModeOptionStruct::DecodableType>;
    using DecodableArgType = const chip::app::DataModel::DecodableList<
        chip::app::Clusters::LowpanHardwareMode::Structs::ModeOptionStruct::DecodableType> &;

    static constexpr ClusterId GetClusterId() { return Clusters::LowpanHardwareMode::Id; }
