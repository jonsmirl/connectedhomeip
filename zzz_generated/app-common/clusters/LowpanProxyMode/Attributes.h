...
#include <clusters/LowpanProxyMode/Enums.h>
...
struct TypeInfo
{
    using Type = chip::app::DataModel::List<const chip::app::Clusters::LowpanProxyMode::Structs::ModeOptionStruct::Type>;
    using DecodableType =
        chip::app::DataModel::DecodableList<chip::app::Clusters::LowpanProxyMode::Structs::ModeOptionStruct::DecodableType>;
    using DecodableArgType =
        const chip::app::DataModel::DecodableList<chip::app::Clusters::LowpanProxyMode::Structs::ModeOptionStruct::DecodableType> &;

    static constexpr ClusterId GetClusterId() { return Clusters::LowpanProxyMode::Id; }
