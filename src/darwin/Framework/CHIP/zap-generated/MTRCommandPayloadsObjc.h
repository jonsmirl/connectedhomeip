...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRLowpanGroupClusterAddGroupEpParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nonnull endpoint MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSString * _Nonnull groupName MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRLowpanGroupClusterRemoveGroupEpParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRLowpanGroupClusterConfigurationParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRLowpanBLESensorClusterAddSensorEpParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRLowpanBLESensorClusterRemoveSensorEpParams : NSObject <NSCopying>
