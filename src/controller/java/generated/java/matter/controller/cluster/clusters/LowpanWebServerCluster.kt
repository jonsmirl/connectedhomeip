...
class LowpanWebServerCluster(
  ...
  suspend fun readJwtAttribute(): String {
    ...
    requireNotNull(attributeData) { "Jwt attribute not found in response" }
  ...
  suspend fun subscribeJwtAttribute(
    minInterval: Int,
    maxInterval: Int,
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Jwt attribute not found in Node State update" }
