...
class ChipClusters:
    ...
    _LOWPAN_BLE_SENSOR_CLUSTER_INFO = {
        "clusterName": "LowpanBleSensor",
        "clusterId": 0xFFF2FC03,
        "commands": {
            0x00000000: {
                "commandId": 0x00000000,
                "commandName": "AddSensorEp",
                "args": {
                    "macAddress": "str",
                },
            },
    ...
    _LOWPAN_WEB_SERVER_CLUSTER_INFO = {
        "clusterName": "LowpanWebServer",
        "clusterId": 0xFFF2FC04,
        "commands": {
        },
        "attributes": {
            0x00000000: {
